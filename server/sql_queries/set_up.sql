...
CREATE TABLE IF NOT EXISTS votes (
    id SERIAL PRIMARY KEY,
    user_id INT NOT NULL,
    note_id INT NULL,  -- Either note_id OR comment_id OR note_id is used
    comment_id INT NULL,
    ...
    CHECK (
        (note_id IS NOT NULL AND comment_id IS NULL)
        OR (note_id IS NULL AND comment_id IS NOT NULL)
    ),
    CHECK (
